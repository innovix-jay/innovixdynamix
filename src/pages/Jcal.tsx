...
const Jcal: React.FC = () => {
  ...
  return (
    <div className="container py-16">
      ...
      <BrandLogo src={["/lovable-uploads/2a736c9d-fe6b-4c72-8c35-7564930ab019.png","/lovable-uploads/jcal-logo.png","/lovable-uploads/jcal-logo.jpg","/lovable-uploads/jcal.svg","/lovable-uploads/jcal.png","/lovable-uploads/jcal.jpg"]} alt="JCAL.ai logo" className="h-[14rem] w-auto mb-6" eager />
      <h1 className="sr-only">JCAL – Structured Collaboration</h1>
