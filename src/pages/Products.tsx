    ...
    <div className="container py-16">
      ...
      <div className="grid gap-6 md:grid-cols-2 mt-8">
        <article id="pcard-jcal" className="glass-card p-6">
          <img src="/lovable-uploads/jcal-logo.png" alt="JCAL.ai logo" className="h-6 w-auto mb-3" loading="lazy" decoding="async" />
        ...
        <article id="pcard-matalino" className="glass-card p-6">
          <img src="/lovable-uploads/matalino-logo.png" alt="Matalino logo" className="h-6 w-auto mb-3" loading="lazy" decoding="async" />
