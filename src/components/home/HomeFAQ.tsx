...
const HomeFAQ: React.FC = () => {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is Innovix Dynamix?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Innovix Dynamix delivers AI Training & Enablement that helps teams adopt AI safely and productively in day-to-day work. We provide a hosted, standards-aligned approach suitable for both government and private sector programs—aligned to OMB M-24-10 and NIST AI Risk Management Framework (AI RMF). Our core capabilities include practical AI patterns and guidance, monthly adoption/completion reporting with a simple Compliance Score snapshot, quarterly content refreshes, and usage-only analytics with no operational data ingestion. Innovix Dynamix also operates two product initiatives from Innovix Dynamix Labs: JCAL.ai (build AI-powered apps with a prompt) and Matalino (tools for small businesses and creators who ship)."
        }
      },
      {
        "@type": "Question",
  ...
  return (
    <section aria-labelledby="faq-heading">
      ...
      <h2 id="faq-heading" className="text-2xl md:text-3xl font-semibold">Frequently Asked Questions</h2>
