...
const Hero: React.FC<React.HTMLAttributes<HTMLElement>> = (props) => {
  return (
    <section id="hero" className="relative overflow-hidden">
      ...
      <div className="hidden sm:block absolute top-3 right-3 md:top-6 md:right-6 z-20">
        <BrandLogo src="/lovable-uploads/72554a38-f8c3-4d22-a0ba-0a7fd173f7be.png" alt="Innovix logo mark" className="w-10 h-10 md:w-12 md:h-12 drop-shadow" />
      </div>
      <div className="container relative z-10 py-28 md:py-36">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mt-6 max-w-2xl animate-fade-in">
            Prompt apps into existence with JCAL.ai. Launch smarter and sell faster with Matalino. Two focused tools serving builders and creators.
          </p>
